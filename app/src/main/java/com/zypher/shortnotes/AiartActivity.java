...
public class AiartActivity extends AppCompatActivity {
    EditText inputText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aiart);
    ...
    void callAPI(String text) {
        ...
        Request request = new Request.Builder()
                ...
                .header("Authorization", "Bearer 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")
                .post(requestBody)
                .build();
